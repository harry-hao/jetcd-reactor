...
public interface ReactiveMaintenance extends CloseableClient {
     ...
     */
    Mono<AlarmResponse> alarmDisarm(AlarmMember member);
     ...
     * @return          the response result
     */
    Mono<DefragmentResponse> defragmentMember(URI endpoint);
     ...
     * @return          the response result
     */
    Mono<StatusResponse> statusMember(URI endpoint);
     ...
     * @return          the response result
     */
    Mono<HashKVResponse> hashKV(URI endpoint, long rev);
     ...
     */
    Mono<Long> snapshot(OutputStream output);
     ...
     */
    Flux<SnapshotResponse> snapshot();
     ...
     * @return              the response result
     */
    Mono<MoveLeaderResponse> moveLeader(long transfereeID);
}
